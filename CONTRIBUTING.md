...
1. You [open a discussion](https://github.com/DonBower/packer-vsphere-ubuntu/discussions) to discuss any significant work with the maintainer(s).
...
```shell
git remote add upstream https://github.com/DonBower/packer-vsphere-ubuntu.git
...
discuss, [open a discussion](https://github.com/DonBower/packer-vsphere-ubuntu/discussions).
